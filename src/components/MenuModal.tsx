      ...
      <div className=" w-[1500px]">
        <div className="grid grid-cols-3 gap-6 mb-8">
          ...
          <section className="bg-white rounded-[20px] p-6 shadow-sm">
            ...
            <div className="space-y-3 text-[14px] text-[#666666] leading-relaxed">
          ...
          <section className="bg-white rounded-[20px] p-6 shadow-sm">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="bg-white px-4 py-2 rounded-lg border border-gray-200">
                <span className="font-bold text-orange-500">HUMO</span>
              </div>
              <div className="bg-white px-4 py-2 rounded-lg border border-gray-200">
                <span className="font-bold text-cyan-500">Payme</span>
              </div>
            </div>
          </section>
          ...
          <section className="bg-white rounded-[20px] p-6 shadow-sm">
            ...
            <div className="space-y-3">
              <a
                ...
                className="flex items-center gap-3 text-[14px] text-[#0088cc] hover:text-[#0088cc]/80 transition-colors"
              >
                ...
                <div>
                  ...
                  <p className="text-[12px] text-[#999]">
                    https://t.me/artlavka.uz
                  </p>
                </div>
              </a>
              <a
                href="mailto:support@artlavka.uz"
                className="flex items-center gap-3 text-[14px] text-[#8814B1] hover:text-[#8814B1]/80 transition-colors"
              >
                <div className="w-8 h-8 bg-[#8814B1] rounded-full flex items-center justify-center text-white">
                  <svg
                    className="w-5 h-5"
                    fill="none"
                    stroke="currentColor"
                ...
                <div>
                  ...
                  <p className="text-[12px] text-[#999]">support@artlavka.uz</p>
                </div>
              </a>
            </div>
          </section>
        ...
        {/* About Us Section */}
        <section className="bg-white rounded-[20px] p-6 shadow-sm">
          <h3 className="text-[20px] font-bold text-[#333333] mb-4">О нас</h3>
          <div className="space-y-4 text-[14px] text-[#666666] leading-relaxed">
            ...
            <div className="space-y-3 pt-4">
              <p className="font-semibold text-[#8814B1]">Художники:</p>
              <a
                href="https://www.instagram.com/yana_zakhary/"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 text-[#E4405F] hover:text-[#E4405F]/80 transition-colors"
              >
                <div className="w-6 h-6 bg-linear-to-br from-[#F58529] via-[#DD2A7B] to-[#8134AF] rounded-lg flex items-center justify-center text-white">
                  <svg
                    className="w-4 h-4"
                    fill="currentColor"
                    viewBox="0 0 24 24"
              ...
              <p className="font-semibold text-[#8814B1] pt-2">
              ...
              <a
                ...
                className="flex items-center gap-2 text-[#E4405F] hover:text-[#E4405F]/80 transition-colors"
              >
                <div className="w-6 h-6 bg-linear-gradient-to-br from-[#F58529] via-[#DD2A7B] to-[#8134AF] rounded-lg flex items-center justify-center text-white">
                  <svg
                    className="w-4 h-4"
                    fill="currentColor"
                    viewBox="0 0 24 24"
