...
export default function NewProductPage() {
  ...
  const [modelPath, setModelPath] = useState("/model/compressed/base.glb");
  ...
  return (
    <div className="w-full">
      <div className="flex justify-between items-center mb-8">
        <h1 className="text-3xl font-bold text-gray-800">Добавить продукт</h1>
      ...
      >
        ...
        {showPreview && (
          <div className="lg:sticky lg:top-8 space-y-6">
            ...
            {/* Instruction Card */}
            <div className="bg-blue-50 border border-blue-100 rounded-[20px] p-6">
              <h4 className="text-blue-800 font-bold mb-2 flex items-center gap-2">
                💡 Советы
              </h4>
              <ul className="text-sm text-blue-700/80 space-y-2 list-disc list-inside">
                <li>Укажите точный путь к GLB модели</li>
                <li>Добавьте цвета для проверки на модели</li>
                <li>Нажмите "Предпросмотр" у цвета в списке</li>
              </ul>
            </div>
          </div>
        )}
